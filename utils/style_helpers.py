...
def style_pitcher_table(df: pd.DataFrame) -> pd.DataFrame.style.Styler:
    """
...
def style_batter_table(df: pd.DataFrame) -> pd.DataFrame.style.Styler:
    """
...
def style_delta_table(df: pd.DataFrame) -> pd.DataFrame.style.Styler:
    """
